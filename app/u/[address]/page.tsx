    ...
    <main className="container py-10 md:py-16">
      ...
      <div className="pixel-card pink">
        ...
        <div className="mt-3 flex flex-col md:flex-row md:items-start md:justify-between gap-6">
          <div>
            <h1 className="text-3xl md:text-4xl font-extrabold pixel-title pink">
              On-Chain Nomad
            </h1>
            ...
            <p className="mt-4 text-sm text-muted max-w-xl">
              Proof → Score → UBI. Share your Nomad identity with a public,
...
END:VCARD`
            ...
            {err && (
              <pre className="scrollbox mono mt-4 text-red-300 whitespace-pre-wrap">
                Load error: {err}
              </pre>
            )}
          </div>
