  ...
  return (
    <Web3Provider>
      ...
      <main className="relative overflow-hidden">
        <section className="container py-16 md:py-24 grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            <h1 className="text-5xl md:text-6xl font-extrabold leading-tight tracking-wide">
              <span className="text-[#00FF6A]">Nomad UBI</span>
              <br />
              Reputation → Income
            </h1>
            <p className="mt-6 text-lg text-white/80 max-w-xl">
              A crypto-native coordination layer where{" "}
              <b>existence becomes yield</b>. Connect your wallet, verify
            ...
            <div className="mt-8 flex gap-4 flex-wrap">
              ...
              <a
                href="https://github.com/KamisAyaka/crowdsourcing_graphql"
                target="_blank"
                className="btn-ghost"
              >
                GitHub
          ...
          >
            ...
            <p className="mt-3 text-sm opacity-85">
              Nomad UBI quantifies contribution across three proofs:
            </p>
        ...
        <section
          id="about"
          className="container pb-20 grid md:grid-cols-3 gap-6"
        >
          {[
            {
              t: "PoP — Presence",
              d: "Join IRL Nomad Islands, scan or verify your attendance.",
              c: "accent-cyan",
            },
            {
              t: "PoC — Contribution",
